...
predictionModelPath = AMAZON_REVENUE_20


tweetGroupDf = pd.read_csv(predictionModelPath.getModelPath()+"\\tweetGroups_at_"+str(predictionModelPath.getTweetGroupSize())+".csv")
firstNZeroClasses = tweetGroupDf[tweetGroupDf["class"]==0.0].head(25)
firstNOneClasses = tweetGroupDf[tweetGroupDf["class"]==1.0].head(25)
