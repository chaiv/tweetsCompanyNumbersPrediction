...
from classifier.transformer.DatasetUtils import generate_batch
...
if  __name__ == "__main__":
    ...
    textEncoder = VocabularyIDEncoder(DataDirHelper().getDataDir()+ "companyTweets\TokenizerAmazon.json")
    ...
    train_data = Dataset(dataframe=train,textEncoder = textEncoder)
    val_data = Dataset(dataframe=val,textEncoder =textEncoder)
    test_data = Dataset(dataframe=test,textEncoder = textEncoder)
