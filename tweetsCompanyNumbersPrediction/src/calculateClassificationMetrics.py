...
checkpoint = torch.load(DataDirHelper().getDataDir()+"companyTweets\\model\\amazonRevenueLSTMN5\\tweetpredict_fold1.ckpt")
...
print("MCC "+str(metrics.calculate_mcc(true_classes, prediction_classes)))
BinaryClassificationMetricsPlots(metrics).createRocAUCAndPrAucPlots(true_classes, prediction_classes)
