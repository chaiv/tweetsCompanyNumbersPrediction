...
class TestPredictor(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.predictor = Predictor(
            self.model_mock, self.tokenizer_mock, self.prediction_class_mapper_mock,
    ...
    def test_calculateWordScores(self):
        ...
        self.tokenizer_mock.encode = MagicMock(return_value=[101, 1103, 1393, 3517, 4653, 1211, 1103, 12903, 4210, 119])
        ...
        expected_scores = [
            ([0, 1, 2, 3, 4, 5, 6, 7, 8], ['The', 'quick', 'brown', 'fox', 'jumps', 'over', 'the', 'lazy', 'dog.'], [1, 2, 3, 4, 5, 6, 7, 8, 9])
        ]
        self.assertEqual(self.predictor.calculateWordScores(sentences, observed_class, n_steps, internal_batch_size), expected_scores)
